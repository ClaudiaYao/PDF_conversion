...
def cleanup_all():
    ...
    cleanup_wrapper(cur_path + "/dataset_ground_truth.json", cur_path + "/dataset.json")
    cleanup_wrapper(cur_path + "/eval_ground_truth.json", cur_path + "/eval.json")
    cleanup_wrapper(cur_path + "/test_ground_truth.json", cur_path + "/test.json")
